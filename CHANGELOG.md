...
- x402 v1.7.1 chain name handling section in `references/x402-integration.md`
- Example 6 in SKILL.md — A2A + x402 combined flow
- 45 new unit tests (226 total)

### Changed
- Upgraded agent0-sdk from 1.6.0 to 1.7.1 (x402 payments, A2A messaging, multichain improvements, chain slug normalization)
...
- All reference docs updated to v1.7.1 (including 8 files previously stale at v1.6.0)
- `.claude-skill.json` version corrected to 2.3.0
- Website updated with 2 new operation cards, docs, and A2A accuracy fixes
